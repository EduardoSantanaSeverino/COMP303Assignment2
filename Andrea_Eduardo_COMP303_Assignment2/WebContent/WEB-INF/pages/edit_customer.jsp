                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="main-content">
                                                ...
                                                <form action="${pageContext.request.contextPath}/customer/edit.html" method="post" role="form">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="card-text">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input value="${customer.firstname}" type="text" name="firstname" class="form-control" id="firstname" required="" maxlength="256">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input value="${customer.lastname}" type="text" name="lastname" class="form-control" id="lastname" required="" maxlength="256" placeholder="Last Name">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input value="${customer.email}" type="text" name="email" class="form-control" id="email" required="" maxlength="256" >
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input value="${customer.address}" type="text" name="address" class="form-control" id="address" required="" maxlength="256" placeholder="Address">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input value="${customer.city}" type="text" name="city" class="form-control" id="city" required="" maxlength="256" placeholder="City">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input value="${customer.postalCode}" type="text" name="postalCode" class="form-control" id="postalCode" required="" maxlength="256" placeholder="Postal Code">
